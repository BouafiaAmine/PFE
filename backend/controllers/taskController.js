...
const createTask = async (req, res) => {
    try {
     ...
     if (!Array.isArray(assignedTo)) {
        return res.status(400).json ({ message: "assignedTp must be an array of user IDs"});
       }
...
const updateTaskChecklist = async (req, res) => {
    try {
        ...
        // Auto-update progress based onn checklist completion
